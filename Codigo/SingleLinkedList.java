 ...
 * 20-02-2023
 */
public class SingleLinkedList<T> extends MadreLista<T> {
    ...
    /** 
     * @param value
     * metodo para insertar un valor al principio
     */
    @Override
    ...
    /** 
     * @param value
     * metodo para insertar un valor al final
     */
    @Override
     ...
     * @param value
     * @param index
     * metodo para inservar un valor en un determinado espacio
     */
    @Override
     ...
     * @param index
     * @return T
     * metodo para eliminar un valor segun su indice
     */
    @Override
    ...
    /** 
     * @return T
     * metodo para eliminar un valor al inicio
     */
    @Override
    ...
    /** 
     * @return T
     * metodo para eliminar un valor al final
     */
    @Override
     ...
     * @param index
     * @return T
     * metodo para obtener un valor segun su indice
     */
    @Override
